...
<head>
  ...
  <title>Agricfarm an Agriculture Category Bootstrap Responsive Template | Services </title>
  <!-- google fonts -->
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="bottom-copies">
        <p class="copy-footer-29 text-center">© 2020 Agricfarm. All rights reserved.</p>
      </div>
    </div>
