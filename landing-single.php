...
<head>
  ...
  <title>Agricfarm an Agriculture Category Bootstrap Responsive Template | Home </title>
  <!-- google fonts -->
    ...
    <div class="container">
      ...
      <a class="navbar-brand" href="#index">
        ...
        <div class="d-lg-block d-none">
          <a href="contact" class="btn btn-style btn-secondary ml-lg-3">Free Quote</a>
        </div>
                      ...
                      <div class="contact-address">
                          <ul>
                              <li class="icon-color"><span class="fa fa-mail-reply"></span><span>
                                  <a href="mailto:travel@mail.com"> Agricfarm@mail.com</a>
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="bottom-copies">
        <p class="copy-footer-29 text-center">© 2020 Agricfarm. All rights reserved.
            </p>
      </div>
    </div>
